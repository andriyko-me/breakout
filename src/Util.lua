...
function GenerateQuadsPowerUps(atlas)
    ...
    local y = 192
    local quads = {
        [1] = love.graphics.newQuad(x, y, 16, 16, atlas:getDimensions()),
        [2] = love.graphics.newQuad(x + 48, y, 16, 16, atlas:getDimensions())
    }
...
function GenerateQuadsLocked(atlas)
    ...
    local quads = {
        [1] = love.graphics.newQuad(x, y, 32, 16, atlas:getDimensions())
    }
